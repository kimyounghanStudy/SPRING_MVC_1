...
public class RequestParamController {
    ...
    public String modelAttributeV1(@ModelAttribute HelloData helloData){
        ...
        // 아래도 가능하다 왜냐면 HelloData 클래스에 @Data 를 사용 중인데 Data 중에 @ToString 이 포함되어있기때문
        // 즉 toString 의 기능이다.
        log.info("helloData={}",helloData);
        return "ok";
    }

    // 그렇다면 @RequestParam과 @ModelAttribute는 어떻게 구분함?
    // 단순타입 or 기본값은 파람으로... 나머지는 ModelAttribute 로 생각한다. 추가로 argument resolver에 등록하면 모델어트리뷰트에 제외
    @ResponseBody
